namespace EriZoo.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ZooContext>
    {
        ...
        protected override void Seed(ZooContext context)
        {
            ...
            {
            new Food{Name="Bamboo",Calories=300,VendorID=vendors.Single( v => v.Name == "Vetrinarian Goods, Inc").ID,Cost=1.24M,Weight=3000},
            new Food{Name="Liquid Protein",Calories=100,VendorID=vendors.Single( v => v.Name == "Gourmet Animal Delite").ID,Cost=1.24M,Weight=2},
            new Food{Name="Mice",Calories=500,VendorID=vendors.Single( v => v.Name == "International Foods").ID,Cost=1.24M,Weight=100},
            new Food{Name="Grass",Calories=2000,VendorID=vendors.Single( v => v.Name == "Vetrinarian Goods, Inc").ID,Cost=1.24M,Weight=1000},
            new Food{Name="Pork",Calories=1000,VendorID=vendors.Single( v => v.Name == "International Foods").ID,Cost=1.24M,Weight=5000},
            new Food{Name="Beef",Calories=1200,VendorID=vendors.Single( v => v.Name == "International Foods").ID,Cost=1.24M,Weight=5000},
            new Food{Name="Leaves",Calories=1000,VendorID=vendors.Single( v => v.Name == "Vetrinarian Goods, Inc").ID,Cost=1.24M,Weight=3000},
            new Food{Name="Mice",Calories=500,VendorID=vendors.Single( v => v.Name == "Gourmet Animal Delite").ID,Cost=1.24M,Weight=1000},
            new Food{Name="Hay",Calories=500,VendorID=vendors.Single( v => v.Name == "Gourmet Animal Delite").ID,Cost=1.24M,Weight=1000},
            new Food{Name="Chicken",Calories=1000,VendorID=vendors.Single( v => v.Name == "Gourmet Animal Delite").ID,Cost=1.24M,Weight=1000}
            };
